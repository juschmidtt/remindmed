...
* Tela inicial com relógio digital (formatação de dois dígitos).
* Tela de detalhes do medicamento.
* Tela de adicionar remédio de forma rápida e intuitiva.
* Mensagens e alertas para lembrar o horário da dose.
* Exclusão de remédios com atualização automática da lista.
